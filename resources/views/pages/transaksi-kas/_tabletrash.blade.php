<div class="table-responsive">
                ...
                <tr class="border-bottom-primary">
                    ...
                    <td>
                        <div class="form-inline">
                            ...
                            {{-- <a href="{{ route('kode-induk.hapusPermanen',$item->kode_transaksi_kas) }}"> --}}
                            <form action="{{ route('transaksiKas.hapusPermanen', [$item->kode_transaksi_kas]) }}" method="post" onsubmit="return confirm('Delete this data permanently ?')">
                                @csrf
    ...
    <div class="pull-right">
        {{ $transaksi_kas->appends(Request::all())->links('vendor.pagination.custom') }}
    </div>
</div>
