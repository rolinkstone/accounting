<form action="#" method="POST">
    <div class="form-group row">
        ...
        <div class="col-sm-4">
            ...
            <input class="form-control form-control-lg {{ $errors->has('tanggal') ? ' is-invalid' : '' }}" type="date" name="tanggal" value="{{ old('tanggal',$transaksi_kas->tanggal) }}" readonly/>
        </div>
        <div class="col-sm-4 ">
    ...
    <div class="detail-lawan">
        <div class="" id='urlAddDetail' data-url="{{ url('kas/kas-transaksi/addEditDetailKasTransaksi') }}">
            ...
            @foreach ($loop as $n => $edit)
                ...
                @endphp
                @include('pages.transaksi-kas.form-show-detail-transaksi-kas',['hapus' => $linkHapus, 'no' => $no, 'kode_lawan' => $kode_lawan])
