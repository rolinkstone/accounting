                ...
                <tr class="border-bottom-primary">
                    ...
                    <td>
                        <div class="form-inline">
                            <a href="{{ route('customer.restore', $item->id) }}" class="mr-2">
                                <button type="button" id="PopoverCustomT-1" class="btn btn-primary btn-sm"
                                    data-toggle="tooltip" title="Restore" data-placement="top"><i class="ti-reload"></i></button>
                            </a>
                            {{-- <a href="{{ route('customer.hapusPermanen',$item->id) }}"> --}}
                            <form action="{{ route('customer.hapusPermanen', [$item->id]) }}" method="post" onsubmit="return confirm('Delete this data permanently ?')">
                                @csrf
